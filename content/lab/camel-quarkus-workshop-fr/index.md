...
layout: page
aliases: [/lab/camel-quarkus-workshop-fr/]
---
...
Enfin, vous apprendrez comment personnaliser le code en implémentant des transformations, des filtres et des routages basés sur le contenu en utilisant des [Enterprise Integration Patterns](https://www.enterpriseintegrationpatterns.com/) disponibles dans [Apache Camel](https://camel.apache.org/).

Je vous conseille de préparer [les prérequis](https://github.com/aldettinger/camel-quarkus-workshop) au préalable.

#### slides
- [Riviera Dev 2023](https://github.com/zbendhiba/zbendhiba.github.io/tree/main/assets/confs/2023/workshop-2023-07-10.pdf)

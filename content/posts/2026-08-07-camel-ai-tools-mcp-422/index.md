...
description: "Camel 4.22 introduces a unified AI tool abstraction and a built-in MCP server. Define a tool once as a Camel route, and it works with LangChain4j, Spring AI, and OpenAI."
image: camel-ai-tool.png
tags: ApacheCamel, AI, Java, MCP
author: zineb
---

*Co-authored with [Federico Mariani](https://github.com/Croway) and [Jiri Ondrusek](https://github.com/JiriOndrusek). Originally published on the [Apache Camel blog](https://camel.apache.org/blog/2026/08/camel-ai-tools-mcp-422/).*

...
Last week, I had the privilege of co-presenting a tech talk alongside [Otavio Piske](https://www.linkedin.com/in/orpiske/). Together, we delved into today's landscape of what we offer to integrate in the GenAI space using Apache Camel.
...
You can access the presentation slides [here](https://speakerdeck.com/zbendhiba/quarkus-insights-number-187-camel-with-ai).

Links to the demos:
- [Data ingestion demo](https://github.com/zbendhiba/chat-application-camel-ingestor)
- [Camel JIRA demo](https://github.com/zbendhiba/camel-ai-samples/tree/main/camel-jira-ai)

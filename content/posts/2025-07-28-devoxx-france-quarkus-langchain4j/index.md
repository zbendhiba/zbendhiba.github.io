...
J'ai récemment eu le plaisir de co-présenter une conférence avec [Clément Escoffier](https://www.linkedin.com/in/clementescoffier/) lors de [Devoxx France](https://www.devoxx.fr/), et je suis ravie de partager l'enregistrement avec vous.
...
- 🔗 **MCP (Model Context Protocol)** : Connecter les IA aux systèmes d'entreprise avec des démos de [Wanaku](https://www.wanaku.ai/) (premier MCP Router open source) et [Quarkus MCP Server](https://github.com/quarkiverse/quarkus-mcp-server)
...
[🎥 Voir la conférence sur YouTube](https://youtu.be/d_2jk8KbQHU?si=679NWkpuMz5MqBry)
...
- 📚 [Documentation officielle](https://docs.quarkiverse.io/quarkus-langchain4j/dev/index.html)
- 💻 [Projet GitHub avec exemples](https://github.com/quarkiverse/quarkus-langchain4j)

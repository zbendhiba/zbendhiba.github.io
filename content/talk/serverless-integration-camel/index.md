...
[Apache Camel](https://camel.apache.org/) has been around for a while, but it is more relevant now than it has ever been. In this session we'll show you how Camel can leverage Quarkus' fast startup time and developer experience to build modern, distributed and cloud native integration workloads. As a bonus it can make use of technologies like serverless computing (eg. Knative) and data streaming (eg. Kafka) to remove bottlenecks, integrate faster and better than ever before, and save resources and money on top of it.

Attendees should come away from this talk with the following:
- Why you would want to use [Apache Camel](https://camel.apache.org/) to create easy to understand, reusable and distributed integration components.
- How the next iteration of [Apache Camel](https://camel.apache.org/) (based on [Quarkus](https://quarkus.io/)) can leverage Kubernetes and/or Serverless computing and event driven architectures to deploy early and often.

### Links

[DEMO](https://github.com/zbendhiba/telegram-kafka/tree/20200201-rhte)
